...
export default function HeaderTop() {
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-800/50 px-6 py-2.5 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 flex flex-col items-center text-center gap-y-2 sm:flex-row sm:text-left sm:items-center sm:gap-x-4">
        <p className="text-sm/6 text-gray-100">
          <strong className="font-semibold">Agency 2026</strong>
      ...
      <div className="flex flex-1 justify-end">
        <button onClick={() => setIsOpen(false)} type="button" className="-m-3 p-3 focus-visible:-outline-offset-4">
